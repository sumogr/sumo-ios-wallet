...
final class NodesView: BaseFlexView {
    ...
    override func configureConstraints() {
        autoNodeSwitchContainer.flex.direction(.row).backgroundColor(.sumokoinBlack80).padding(0, 20, 0, 20).justifyContent(.spaceBetween).alignItems(.center).height(60).define { flex in
